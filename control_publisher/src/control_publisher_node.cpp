...
int main(int argc, char **argv) {
    ...
    ros::Publisher control_pub = n.advertise<geometry_msgs::Twist>("twist_control_effort", 1);
    ...
    ros::Subscriber angularControlSub = n.subscribe("angular_control_effort", 1, angular_control);
